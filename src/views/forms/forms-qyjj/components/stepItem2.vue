  ...
  <cardVue :collapse="false" title="企业简介">
    <van-form ref="vanFormRef">
      <van-cell-group inset>
        <pr-select-van-field label-width="100" :required="true" v-model="inf.companyAttr" :columns="dictConfigRes.companyAttr" is-link readonly name="企业属性" label="企业属性" placeholder="请选择" :rules="[{ required: true, message: '请选择企业属性' }]" />
        <pr-select-van-field label-width="100" :required="true" v-model="inf.isProceed" :columns="dictConfigRes.isProceed" is-link readonly name="企业涉诉情况" label="企业涉诉情况" placeholder="请选择" :rules="[{ required: true, message: '请选择企业涉诉情况' }]" />
        <pr-select-van-field label-width="100" :required="true" v-model="inf.businessStatus" :columns="dictConfigRes.businessStatus" is-link readonly name="经营状况" label="经营状况" placeholder="请选择" :rules="[{ required: true, message: '请选择经营状况' }]" />
        ...
        <pr-select-van-field label-width="100" :required="true" v-model="inf.payType" :columns="dictConfigRes.payType" is-link readonly name="缴纳方式" label="缴纳方式" placeholder="请选择" :rules="[{ required: true, message: '请选择缴纳方式' }]" />
        <pr-select-van-field label-width="100" :required="true" v-model="inf.industrialNature" :columns="dictConfigRes.industrialNature" is-link readonly name="产业性质" label="产业性质" placeholder="请选择" :rules="[{ required: true, message: '请选择产业性质' }]" />
